...
public class Verify_Search_UniversityRepresentatives {
	@Test
	public void search_test_university_representative() throws InterruptedException {
		...
		WebElement search_representative = driver.findElement(By.xpath("//*[@id=\"universitydatatable-table_filter\"]/label/input"));
		search_representative.click();
		Thread.sleep(2000);
		search_representative.sendKeys("IMRAN");
		Thread.sleep(3000);
