...
public class Verify_PreviousNext_UniversityRepresentatives {
	@Test
	public void previous_next_test() throws InterruptedException {
		...
		//Previous Next
		WebElement next_representative = driver.findElement(By.xpath("//*[@id=\"universitydatatable-table_next\"]/a"));
		next_representative.click();
		Thread.sleep(2000);
		
		WebElement previous_representative = driver.findElement(By.xpath("//*[@id=\"universitydatatable-table_previous\"]"));
