...
public class VerifyPreviousNextPrograms extends DriverSetup {
	@Test
	public void PreviousnextTest() throws InterruptedException {
		...
		//Previous Next
		WebElement nextRepresentative = driver.findElement(By.xpath("//*[@id=\"institutionprogram-table_next\"]/a"));
		nextRepresentative.click();
		Thread.sleep(2000);
					
		WebElement previousRepresentative = driver.findElement(By.xpath("//*[@id=\"institutionprogram-table_previous\"]"));
