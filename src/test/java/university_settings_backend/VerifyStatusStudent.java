...
public class VerifyStatusStudent extends DriverSetup {
	@Test
	public void StatusTest() throws InterruptedException {
		...
		//Status
		//Active
		WebElement StudentInactiveActive = driver.findElement(By.xpath("//*[@id=\"student-table\"]/tbody/tr[1]/td[7]/button"));
		StudentInactiveActive.click();
		Thread.sleep(2000);
