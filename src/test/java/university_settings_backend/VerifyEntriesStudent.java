...
public class VerifyEntriesStudent extends DriverSetup {
	@Test
	public void EntriesTest() throws InterruptedException {
		...
		//10
		driver.findElement(By.xpath("//*[@id=\\\\\\\"student-table_length\\\\\\\"]/label/select/option[2]")).click();
		entries_student.click();
		Thread.sleep(1000);
		...
		//50
		driver.findElement(By.xpath("//*[@id=\\\"student-table_length\\\"]/label/select/option[3]")).click();
		entries_student.click();
		Thread.sleep(1000);
		
		//100
		driver.findElement(By.xpath("//*[@id=\\\"student-table_length\\\"]/label/select/option[4]")).click();
		entries_student.click();
		Thread.sleep(1000);
