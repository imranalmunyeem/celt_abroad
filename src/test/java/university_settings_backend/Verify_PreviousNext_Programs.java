...
public class Verify_PreviousNext_Programs {
	@Test
	public void previousnext_test() throws InterruptedException {
		...
		//Previous Next
		WebElement next_representative = driver.findElement(By.xpath("//*[@id=\"institutionprogram-table_next\"]/a"));
		next_representative.click();
		Thread.sleep(2000);
					
		WebElement previous_representative = driver.findElement(By.xpath("//*[@id=\"institutionprogram-table_previous\"]"));
