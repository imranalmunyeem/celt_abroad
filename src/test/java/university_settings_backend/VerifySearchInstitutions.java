...
public class VerifySearchInstitutions extends DriverSetup{
	@Test
	public void SearchTestInstitutions() throws InterruptedException {
		...
		//Search Institutions
		WebElement searchInstitutions = driver.findElement(By.xpath("//*[@id=\"institution-table_filter\"]/label/input"));
		searchInstitutions.click();
		Thread.sleep(2000);
		searchInstitutions.sendKeys("34");	
		Thread.sleep(2000);
