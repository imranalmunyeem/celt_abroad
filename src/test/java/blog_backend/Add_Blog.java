...
public class Add_Blog {
	@Test
	public void add_test_blog() throws InterruptedException {
		...
		//Add
		WebElement add_blog = driver.findElement(By.xpath("//*[@id=\"wrapper\"]/div[2]/div/div[2]/div/div[2]/div/div/div/div[1]/div/a"));
		add_blog.click();
		Thread.sleep(2000);
		...
		WebElement blog_category = driver.findElement(By.xpath("//*[@id=\"en[category_id]\"]"));
		blog_category.click();
		Thread.sleep(2000);
		...
		//Blog Title 
		WebElement blog_title = driver.findElement(By.xpath("//*[@id=\"en[title]\"]"));
		blog_title.sendKeys("Bike");
		Thread.sleep(2000);
		...
		//Submit
		WebElement blog_submit = driver.findElement(By.xpath("/html/body/div[2]/div[2]/div/div[2]/div[1]/div[2]/div/div/div/div[2]/div/div/div/form/div[2]/div/div[6]/button"));
		blog_submit.click();
		Thread.sleep(2000);
