...
public class Verify_Entries_Region {
	@Test
	public void test_entries_regions() throws InterruptedException {
		...
		//entries
		WebElement entries_regions = driver.findElement(By.xpath("//*[@id=\"region_datatable-table_length\"]/label/select"));
		entries_regions.click();
		Thread.sleep(2000);
