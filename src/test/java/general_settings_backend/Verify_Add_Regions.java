...
public class Verify_Add_Regions {
	@Test
	public void verify_test_regions() throws InterruptedException {
		...
		//Navigate to add
		WebElement add_navigate = driver.findElement(By.xpath("//*[@id=\"wrapper\"]/div[2]/div/div[2]/div/div[2]/div/div/div/div[1]/div/a"));
		add_navigate.click();
		Thread.sleep(1000);
		
		//Add Region
		WebElement add_regions = driver.findElement(By.xpath("//*[@id=\"en\"]"));
		add_regions.click();
		Thread.sleep(2000);
		WebElement title_regions = driver.findElement(By.xpath("//*[@id=\"en_title\"]"));
		title_regions.click();
		title_regions.sendKeys("UK");
		Thread.sleep(2000);
