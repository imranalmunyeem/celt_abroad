...
public class Verify_Entries_Languages {
	@Test
	public void languages_test_general_settings() throws InterruptedException {
		...
		//entries
		WebElement entries_blog = driver.findElement(By.xpath("//*[@id=\"language-table_length\"]/label/select"));
		entries_blog.click();
		Thread.sleep(2000);
