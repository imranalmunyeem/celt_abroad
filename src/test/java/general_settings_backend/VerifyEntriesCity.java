...
public class VerifyEntriesCity extends DriverSetup{
	@Test
	public void EntriesTest() throws InterruptedException {
		...
		//10
		driver.findElement(By.xpath("//*[@id=\\\"city_datatables_length\\\"]/label/select/option[1]")).click();
		Thread.sleep(1000);
		entriesCountries.click();
		Thread.sleep(1000);
		...
		//50
		driver.findElement(By.xpath("//*[@id=\\\"city_datatables_length\\\"]/label/select/option[2]")).click();
		Thread.sleep(1000);
		entriesCountries.click();
		Thread.sleep(1000);
						
		//100
		driver.findElement(By.xpath("//*[@id=\\\"city_datatables_length\\\"]/label/select/option[3]")).click();
		Thread.sleep(1000);
		entriesCountries.click();
		Thread.sleep(2000);
